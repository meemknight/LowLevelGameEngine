...
<h2>What is it?</h2>
<p>It is the official game engine developed by the Low Level Game Dev community.</p>

<ul>
    <li><a href="https://www.youtube.com/@lowlevelgamedev9330">YouTube</a></li>
    <li><a href="https://discord.gg/eehehsPAka">Discord</a></li>
</ul>

<hr>

<h2>Why?</h2>
<p>It is a place where everyone can learn some game programming. <strong>Everyone</strong> can contribute to this engine, no matter the programming experience. If you are a beginner and you can think of a simple feature that this engine might need you are free to add it to the engine. We are here to learn, have fun!</p>
<hr>


<h2>How Can I join?</h2>

<p>We recommend joining the <a href="https://discord.gg/eehehsPAka">Discord</a> server to make it as easy as possible to discuss what and who you can work with!<br>
Alternatively, it's completely possible to contribute without joining the discord, however that will lead to a higher risk of collisions and wasted work.</p>

<hr>

<h2>How to contribute to the engine?</h2>
